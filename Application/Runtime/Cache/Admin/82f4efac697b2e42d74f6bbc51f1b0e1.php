        ...
        <ul class="nav navbar-right top-nav">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a href="/mysite/admin.php?c=admin&a=add"><i class="fa fa-fw fa-user"></i> 用户管理</a>
                    </li>
                    <li class="divider"></li>
                    <li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li>
                        <i class="fa fa-dashboard"></i>  <a href="/scms/admin.php?c=admin">用户管理</a>
                    </li>
                    <li class="active">
...
<script>
    ...
    var SCOPE = {
        'save_url' : '/scms/admin.php?c=admin&a=add',
        'jump_url' : '/scms/admin.php?c=admin',
    }
</script>
