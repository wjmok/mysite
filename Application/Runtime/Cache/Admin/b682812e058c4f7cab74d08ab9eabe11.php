...
<body>
 ...
 $navs = D("Menu")->getAdminMenus(); $username = getLoginUsername(); foreach($navs as $k=>$v) { if($v['c'] == 'admin' && $username != 'admin') { unset($navs[$k]); } } $index = 'index'; ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i> <a href="/mysite/admin.php?c=admin">用户管理</a>
                            </li>
                            <li class="active">
    ...
    <script>
    var SCOPE = {
        'add_url': '/mysite/admin.php?c=admin&a=add',
        'edit_url': '/mysite/admin.php?c=admin&a=edit',
        'set_status_url': '/mysite/admin.php?c=admin&a=setStatus',
        'index_url': '/',
