...
<div id="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
	<div class="col-lg-12">
		<a href="/scms/admin.php?c=basic"><button type="button" class="btn <?php if($type == 1): ?>btn-primary<?php endif; ?>"> 基本配置</button></a>
		<a href="/scms/admin.php?c=basic&a=cache"><button type="button" class="btn <?php if($type == 2): ?>btn-primary<?php endif; ?>"> 缓存配置</button></a>
	</div>
</div>
		<!-- /.row -->
...
<!-- /#wrapper -->
<script type="text/javascript" src="/scms/Public/js/admin/form.js"></script>
<script>
	var SCOPE = {
		'save_url' : '/scms/admin.php?c=basic&a=add',
		'jump_url' : '/scms/admin.php?c=basic',
	};
