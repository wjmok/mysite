              ...
              <table class="table table-bordered table-hover singcms-table">
                ...
                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($new["news_id"]); ?>" ></span>
                      ...
                      <a target="_blank" href="/scms/index.php?c=detail&a=view&id=<?php echo ($new["news_id"]); ?>" class="sing_cursor glyphicon glyphicon-eye-open" aria-hidden="true"  ></a>
...
<script>
  var SCOPE = {
    'edit_url' : '/scms/admin.php?c=content&a=edit',
    'add_url' : '/scms/admin.php?c=content&a=add',
    'set_status_url' : '/scms/admin.php?c=content&a=setStatus',
    'sing_news_view_url' : '/scms/index.php?c=view',
    'listorder_url' : '/scms/admin.php?c=content&a=listorder',
    'push_url' : '/scms/admin.php?c=content&a=push',
  }
</script>
